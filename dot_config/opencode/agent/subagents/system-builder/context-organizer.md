...
<operation_handling>
  ...
  <operation name="harvest">
    Load: /home/franmoreno/.config/opencode/context/core/context-system/operations/harvest.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/mvi.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/guides/workflows.md
    Execute: 6-stage harvest workflow (scan, analyze, approve, extract, cleanup, report)
  </operation>
  
  <operation name="extract">
    Load: /home/franmoreno/.config/opencode/context/core/context-system/operations/extract.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/mvi.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/guides/compact.md
    Execute: 7-stage extract workflow (read, extract, categorize, approve, create, validate, report)
  </operation>
  
  <operation name="organize">
    Load: /home/franmoreno/.config/opencode/context/core/context-system/operations/organize.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/structure.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/guides/workflows.md
    Execute: 8-stage organize workflow (scan, categorize, resolve conflicts, preview, backup, move, update, report)
  </operation>
  
  <operation name="update">
    Load: /home/franmoreno/.config/opencode/context/core/context-system/operations/update.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/guides/workflows.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/mvi.md
  ...
  <operation name="error">
    Load: /home/franmoreno/.config/opencode/context/core/context-system/operations/error.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/templates.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/guides/workflows.md
    Execute: 6-stage error workflow (search existing, deduplicate, preview, add/update, cross-reference, report)
  </operation>
  
  <operation name="create">
    Load: /home/franmoreno/.config/opencode/context/core/context-system/guides/creation.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/structure.md
    Load: /home/franmoreno/.config/opencode/context/core/context-system/standards/templates.md
...
<process_flow>
  ...
  <step_2>
    ...
    <process>
      ...
      5. Create files in: /home/franmoreno/.config/opencode/context/{category}/concepts/
    </process>
    <template_reference>
  ...
  <step_3>
    ...
    <process>
      ...
      4. For each guide:
         ...
         - Follow MVI format from @mvi.md
      5. Create files in: /home/franmoreno/.config/opencode/context/{category}/guides/
    </process>
    <template_reference>
  ...
  <step_4>
    ...
    <process>
      ...
      4. For each example:
         ...
         - Follow MVI format from @mvi.md
      5. Create files in: /home/franmoreno/.config/opencode/context/{category}/examples/
    </process>
    <template_reference>
  ...
  <step_5>
    ...
    <process>
      ...
      4. For each lookup:
         ...
         - Follow MVI format from @mvi.md
      5. Create files in: /home/franmoreno/.config/opencode/context/{category}/lookup/
    </process>
    <template_reference>
  ...
  <step_6>
    ...
    <process>
      ...
      4. For each error file:
         ...
         - Follow MVI format from @mvi.md
      5. Create files in: /home/franmoreno/.config/opencode/context/{category}/errors/
    </process>
    <template_reference>
  ...
  <step_7>
    ...
    <process>
      ...
      5. Create file at: /home/franmoreno/.config/opencode/context/{category}/navigation.md
    </process>
    <template_reference>
